...
if [ -d "/usr/share/zooInited" ] ; then
    ...
    #echo "export SERVER_JVMFLAGS=\"-Djava.rmi.server.hostname=172.17.0.50 -Dcom.sun.management.jmxremote.port=18050 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false\"" >> /etc/default/zookeeper
