#!/bin/sh
wget https://codeload.github.com/taosdata/TDengine/zip/ver-2.0.3.1
unzip ver-2.0.3.1
cp Dockerfile TDengine-ver-2.0.3.1
cd TDengine-ver-2.0.3.1
docker build -t evoup/tdengine:2.0.3.1 .
